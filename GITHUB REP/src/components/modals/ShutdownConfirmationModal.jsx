			...
			>
				...
				<div className="mb-6">
					<p className={`${colors.textSecondary} mb-4`}>
						Are you sure you want to shutdown this LUXEGENIE ?
					</p>
					...
					<p className={`text-sm ${colors.textMuted} mt-3`}>
						The device will be powered off and will need to be
						manually restarted.
					</p>
				</div>
				...
				<div className="flex space-x-3">
					...
					<button
						onClick={
							device.assigned_to_table_no
								? () =>
										toast("Cannot shutdown device assigned to a table", {
					...
					>
						{isLoading ? "Shutting down..." : "Yes, Shutdown"}
					</button>
				</div>
			</div>
		</div>
...
export default ShutdownConfirmationModal;
